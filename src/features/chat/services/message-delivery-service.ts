...
export class MessageDeliveryService {
  ...
  private emitStatusUpdate(record: MessageDeliveryRecord): void {
    ...
    websocketManager
      ...
      .catch((error) => {
        // Log broadcast errors for debugging but don't fail
        // Broadcast failures are non-critical - message is still saved to DB
        console.warn(
          `[MessageDelivery] Status broadcast failed for message ${record.messageId}:`,

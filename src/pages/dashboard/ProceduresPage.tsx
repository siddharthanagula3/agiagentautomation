    ...
    <div className="space-y-8">
      ...
      <div>
        ...
        <p className="text-muted-foreground mt-2">
          Manage and execute standard procedures for AI workforce operations.
        </p>
      </div>
        ...
        <CardContent>
          <div className="text-center py-12">
            ...
            <p className="text-muted-foreground mb-6">
              This page will contain procedure management with creation, execution, and tracking tools.
            </p>
            <Button>

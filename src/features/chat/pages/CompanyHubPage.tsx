/**
 * Company Hub Page
 * Multi-agent collaborative workspace where AI employees work together
 */
...
import { TokenBillingTracker } from '../components/TokenBillingTracker';
import { UpsellModal } from '../components/UpsellModal';
import { CompanyHubChat } from '../components/CompanyHubChat';

const CompanyHubPage: React.FC = () => {
        ...
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="mt-1 text-slate-400">Collaborative AI Workspace</p>
            </div>
          </div>

/**
 * ChatKit Page
 * Main page for the ChatKit-inspired chat interface with three tabs
 */
      ...
      <div className="flex flex-col h-screen bg-gray-50">
        <div className="flex-1 flex items-center justify-center">
          <div className="text-center">
            ...
            <p className="text-gray-600">Loading AI employees...</p>
          </div>
        </div>
      </div>
    );
        ...
        <div className="flex-1 flex items-center justify-center">
          <Card className="max-w-md mx-auto">
            <CardContent className="p-6 text-center">
              ...
              <h2 className="text-lg font-semibold mb-2">No AI Employees Found</h2>
              <p className="text-gray-600 mb-4">
                You need to purchase AI employees from the marketplace to start chatting.
              </p>
        ...
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-4">
            ...
            <div className="flex items-center gap-3">
              ...
              <div>
                <h1 className="text-xl font-semibold text-gray-900">ChatKit AI Chat</h1>
                <p className="text-sm text-gray-600">
                  Multi-LLM chat interface with {providerStatus.configuredCount}/{providerStatus.total} providers configured
                </p>
              </div>
            </div>
          </div>
              ...
              <div className="space-y-2">
                ...
                <div className="flex items-center justify-between text-sm">
                  ...
                  <span className="font-medium">
                    {new Date(selectedEmployee.usage_stats.last_used).toLocaleDateString()}
                  </span>
                </div>
              </div>
            </div>
          ...
          {activeSessionId && selectedEmployee ? (
            ...
            <div className="flex-1 flex items-center justify-center">
              <div className="text-center">
                ...
                <h2 className="text-xl font-semibold mb-2">Select an AI Employee</h2>
                <p className="text-gray-600 mb-4">
                  Choose an AI employee to start a conversation
                </p>
      ...
      <Dialog open={showEmployeeSelector} onOpenChange={setShowEmployeeSelector}>
        <DialogContent className="max-w-2xl">
          <DialogHeader>
            ...
            <DialogDescription>
              Choose an AI employee to start a conversation with
            </DialogDescription>
          </DialogHeader>

...
async def run_test():
    ...
    try:
        ...
        # Inject failure or simulate timeout in task execution for an AI Employee.
        ...
        # Inject failure or simulate timeout in task execution for an AI Employee by starting a new task and configuring failure simulation.
        frame = context.pages[-1]

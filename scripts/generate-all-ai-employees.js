...
const allAIEmployees = [
  ...
  },
  {
    ...
    category: 'Engineering',
    description: 'Create responsive, interactive user interfaces',
    provider: 'claude',
    price: 10,
    skills: ['React', 'TypeScript', 'CSS', 'UI/UX', 'Performance'],
    specialty: 'Frontend development and user experience',
    fitLevel: 'excellent',
    defaultTools: [
      'code_interpreter',
      'create_visualization',
  ...
  },
  {
    ...
    specialty: 'End-to-end web development',
    fitLevel: 'excellent',
    popular: true,
    defaultTools: [
      'code_interpreter',
  ...
  },
  {
    ...
    fitLevel: 'excellent',
    defaultTools: ['api_call', 'web_search', 'analyze_file'],
  },
  {
    id: 'emp-007',
    name: 'Cloud Engineer',
    ...
    specialty: 'Cloud infrastructure and architecture',
    fitLevel: 'excellent',
    defaultTools: ['api_call', 'web_search', 'analyze_file'],
  },
  {
    ...
    category: 'Engineering',
    description: 'Implement security measures and protect systems from threats',
    provider: 'claude',
    price: 10,
    skills: [
      'Cybersecurity',
    ...
    specialty: 'Cybersecurity and system protection',
    fitLevel: 'excellent',
  ...
  },
  {
    ...
    specialty: 'Data infrastructure and pipelines',
    fitLevel: 'excellent',
  ...
  },
  {
    ...
    specialty: 'Digital marketing execution and optimization',
    fitLevel: 'excellent',
    defaultTools: ['web_search', 'create_visualization', 'analyze_file'],
  },
  {
    ...
    category: 'Marketing',
    description: 'Create and manage content marketing strategies and campaigns',
    provider: 'chatgpt',
    price: 10,
    skills: [
      'Content Strategy',
  ...
  },
  {
    ...
    category: 'Marketing',
    description: 'Manage social media presence and engagement across platforms',
    provider: 'chatgpt',
    price: 10,
    skills: [
  ...
  },
  {
    ...
    role: 'SEO Specialist',
    category: 'Marketing',
    description: 'Optimize websites and content for search engine visibility',
    provider: 'chatgpt',
    price: 10,
    skills: [
      'SEO',
  ...
  },
  {
    ...
    category: 'Design',
    description:
      'Create visual designs for branding, marketing, and communications',
    provider: 'gemini',
    price: 10,
    skills: ['Visual Design', 'Branding', 'Typography', 'Layout Design'],
    specialty: 'Visual design and branding',
    fitLevel: 'excellent',
    defaultTools: ['create_visualization', 'web_search', 'analyze_file'],
  },
  {
    ...
    category: 'Design',
    description: 'Design products and features that solve user problems',
    provider: 'gemini',
    price: 10,
    skills: [
      'Product Design',
    ...
    specialty: 'Product design and user research',
    fitLevel: 'excellent',
    defaultTools: ['create_visualization', 'web_search', 'analyze_file'],
  },
  {
    ...
    role: 'Brand Designer',
    category: 'Design',
    description: 'Develop and maintain brand identity and visual guidelines',
    provider: 'gemini',
    price: 10,
    skills: [
      'Brand Design',
    ...
    specialty: 'Brand design and identity',
    fitLevel: 'excellent',
    defaultTools: ['create_visualization', 'web_search', 'analyze_file'],
  },
  {
    ...
    category: 'Design',
    description:
      'Create animations and motion graphics for digital experiences',
    provider: 'gemini',
    price: 10,
    skills: ['Animation', 'Motion Graphics', 'Video Editing', 'After Effects'],
  ...
  // Sales & Business Development (20 employees)
  {
    ...
    category: 'Sales',
    description:
      'Lead sales team and develop strategies to achieve revenue targets',
    provider: 'chatgpt',
    price: 10,
    skills: [
      'Sales Strategy',
    ...
    specialty: 'Sales leadership and strategy',
    fitLevel: 'excellent',
    popular: true,
    defaultTools: ['web_search', 'analyze_file'],
  },
  {
    ...
    category: 'Sales',
    description: 'Manage key client relationships and drive sales growth',
    provider: 'chatgpt',
    price: 10,
    skills: [
      'Account Management',
    ...
    specialty: 'Account management and sales',
    fitLevel: 'excellent',
    defaultTools: ['web_search', 'analyze_file'],
  },
  {
  ...
  },
  {
    ...
    specialty: 'Lead generation and qualification',
    fitLevel: 'excellent',
    defaultTools: ['web_search', 'analyze_file'],
  },
  {
  ...
  },
  {
    ...
    category: 'Analytics',
    description:
      'Create reports and dashboards to support business intelligence',
    provider: 'perplexity',
    price: 10,
    skills: [
      'Business Intelligence',
    ...
    specialty: 'Business intelligence and reporting',
    fitLevel: 'excellent',
    defaultTools: ['web_search', 'create_visualization', 'analyze_file'],
  },
  {
    ...
    specialty: 'Marketing analytics and optimization',
    fitLevel: 'excellent',
    defaultTools: ['web_search', 'create_visualization', 'analyze_file'],
  },
  {
    ...
    specialty: 'Product analytics and insights',
    fitLevel: 'excellent',
    defaultTools: ['web_search', 'create_visualization', 'analyze_file'],
  },
  {
    ...
    category: 'Analytics',
    description: 'Analyze financial data and support business planning',
    provider: 'perplexity',
    price: 10,
    skills: [
      'Financial Analysis',
    ...
    specialty: 'Financial analysis and planning',
    fitLevel: 'excellent',
    defaultTools: ['web_search', 'create_visualization', 'analyze_file'],
  },
  ...
  },
  {
    ...
    category: 'Support',
    description: 'Provide technical assistance and troubleshoot complex issues',
    provider: 'chatgpt',
    price: 10,
    skills: [
      'Technical Support',
  ...
  },
  {
    ...
    category: 'Support',
    description: 'Help customers achieve success with products and services',
    provider: 'chatgpt',
    price: 10,
    skills: ['Customer Success', 'Onboarding', 'Training', 'Retention'],
    specialty: 'Customer success and onboarding',
    fitLevel: 'excellent',
    defaultTools: ['web_search', 'analyze_file'],
  },
  {
    ...
    category: 'Support',
    description: 'Provide first-line technical support and issue resolution',
    provider: 'chatgpt',
    price: 10,
    skills: [
      'Help Desk',
    ...
    specialty: 'Help desk and technical support',
    fitLevel: 'excellent',
    defaultTools: ['web_search', 'analyze_file'],
  },
  {
    ...
    category: 'Support',
    description: 'Ensure product quality and identify issues before release',
    provider: 'chatgpt',
    price: 10,
    skills: [
      'Quality Assurance',
  ...
  // Business & Operations (15 employees)
  {
    ...
    specialty: 'Business analysis and process improvement',
    fitLevel: 'excellent',
    popular: true,
    defaultTools: ['web_search', 'analyze_file'],
  },
  {
    ...
    category: 'Business',
    description:
      'Plan and execute projects to deliver results on time and budget',
    provider: 'chatgpt',
    price: 10,
    skills: [
      'Project Management',
  ...
  },
  {
    ...
    specialty: 'Operations management and optimization',
    fitLevel: 'excellent',
    defaultTools: ['web_search', 'analyze_file'],
  },
  {
    ...
    specialty: 'Product management and strategy',
    fitLevel: 'excellent',
    defaultTools: ['web_search', 'analyze_file'],
  },
  {
    ...
    category: 'Business',
    description: 'Manage multiple related projects and strategic initiatives',
    provider: 'chatgpt',
    price: 10,
    skills: [
      'Program Management',
    ...
    specialty: 'Program management and strategic coordination',
    fitLevel: 'excellent',
    defaultTools: ['web_search', 'analyze_file'],
  },
  ...
  // Creative & Content (10 employees)
  {
    ...
    category: 'Creative',
    description:
      'Create engaging written content for various marketing channels',
    provider: 'chatgpt',
    price: 10,
    skills: ['Content Writing', 'Copywriting', 'SEO Writing', 'Blog Writing'],
    specialty: 'Content writing and copywriting',
    fitLevel: 'excellent',
    popular: true,
    defaultTools: ['web_search', 'analyze_file'],
  },
  ...
  },
  {
    ...
    specialty: 'Social media content creation',
    fitLevel: 'excellent',
    defaultTools: ['web_search', 'analyze_file'],
  },
  {
    ...
    role: 'Copywriter',
    category: 'Creative',
    description: 'Write persuasive copy for marketing and advertising',
    provider: 'chatgpt',
    price: 10,
    skills: ['Copywriting', 'Advertising', 'Marketing Copy', 'Brand Voice'],
    specialty: 'Copywriting and advertising',
    fitLevel: 'excellent',
    defaultTools: ['web_search', 'analyze_file'],
  },
  {
    ...
    specialty: 'Content strategy and planning',
    fitLevel: 'excellent',
    defaultTools: ['web_search', 'analyze_file'],
  },
  ...
  },
  {
    ...
    specialty: 'Market research and analysis',
    fitLevel: 'excellent',
    defaultTools: ['web_search', 'analyze_file', 'create_visualization'],
  },
  {
    ...
    category: 'Research',
    description: 'Monitor competitors and provide strategic insights',
    provider: 'perplexity',
    price: 10,
    skills: [
      'Competitive Analysis',
    ...
    specialty: 'Competitive intelligence and analysis',
    fitLevel: 'excellent',
    defaultTools: ['web_search', 'analyze_file', 'create_visualization'],
  },
  {
    ...
    specialty: 'User research and usability testing',
    fitLevel: 'excellent',
    defaultTools: ['web_search', 'analyze_file', 'create_visualization'],
  },
  {
    ...
    category: 'Research',
    description: 'Analyze industry trends and provide strategic insights',
    provider: 'perplexity',
    price: 10,
    skills: [
      'Industry Analysis',
    ...
    specialty: 'Industry analysis and strategic insights',
    fitLevel: 'excellent',
    defaultTools: ['web_search', 'analyze_file', 'create_visualization'],
  },
...
console.log(
  '🚀 Starting comprehensive AI Employee System Prompt Generation...'
);
...
const outputPath = path.join(
  __dirname,
  '../supabase/migrations/20250110000008_add_comprehensive_ai_employees.sql'
);
const sqlContent = `-- ================================================================
...
console.log(
  `✅ Generated comprehensive system prompts for ${employeeCount} AI employees`
);
...
console.log(
  '📊 Categories covered: Engineering, Marketing, Design, Sales, Analytics, Support, Business, Creative, Research'
);
console.log(
  '🔧 All employees have professional system prompts, capabilities, and tool configurations'
);

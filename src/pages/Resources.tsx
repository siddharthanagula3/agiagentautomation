...
const ResourcesPage: React.FC = () => {
  ...
  const resources: Resource[] = [
    ...
    },
    {
      ...
      description:
        'Developer guide to integrating AGI Agent Automation with your existing tech stack using our API and webhooks.',
      type: 'Guide',
    ...
    },
    {
      ...
      description:
        'Visual guide to connecting AGI Agent Automation with Slack, Salesforce, HubSpot, and 50+ other tools.',
      type: 'Video',

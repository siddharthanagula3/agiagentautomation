  ...
  const sections = [
    {
      ...
      content: `By accessing and using AGI Agent Automation, you accept and agree to be bound by these Terms of Service. If you do not agree to these terms, please do not use our services.
...
These terms apply to all users, including visitors, registered users, and paid subscribers. We reserve the right to modify these terms at any time, and will notify users of significant changes.`,
    },
    {
      ...
      content: `AGI Agent Automation provides:
